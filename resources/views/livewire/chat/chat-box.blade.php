        ...
        <main class="flex flex-col gap-3 p-2.5 overflow-y-auto flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
          ...
          <div @class([
            ...
            <div @class(['shrink-0 ' ])>
              ...
              <div @class(['flex flex-wrap text-[15px] rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8] ',
                              'rounded-bl-none border border-gray-200/40'=>false,
                              'rounded-br-none bg-blue-500/80 text-white'=>true     
                ])>

                <p class="whitespace-normal truncate text-sm md:text:text-base tracking-wide lg:tracking-normal">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero ipsum nemo blanditiis optio omnis incidunt corporis praesentium adipisci voluptatibus consequuntur?
                </p>
